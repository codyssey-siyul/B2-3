...
> 본 프로젝트는 팀 프로젝트 과제 내용을 기반으로 개인 학습 및 실습 목적으로 별도로 구현
...
공통 기획안을 이미지 생성 AI에 바로 전달하는 대신, 먼저 별도의 AI 노드를 통해 **이미지 생성에 최적화된 영어 프롬프트**를 생성하도록 구성하
...
본 프로젝트의 핵심은 단순히 AI 콘텐츠를 생성하는 것이 아니라 **하나의 입력을 여러 플랫폼에 적합한 콘텐츠로 자동 변환하는 전체 파이프라인을 구축**
...
사용자는 처음에 주제와 상세 내용만 입력하면 되며 이후 과정은 자동으로 처리
